...
namespace ConsoleApplication2
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("A型的有：" + countA + " 人，占 " + persentA + " %");
            Console.WriteLine("B型的有：" + countB + " 人，占 " + persentB + " %");
            Console.WriteLine("AB型的有：" + countAB + " 人，占 " + persentAB + " %");
            Console.WriteLine("O型的有：" + countO + " 人，占 " + persentO + " %");
